...
async function login(email, password) {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["api"].post(`${API_URL}/auth/login`, {
        email,
        password
    });
    if (res.data.token) {
